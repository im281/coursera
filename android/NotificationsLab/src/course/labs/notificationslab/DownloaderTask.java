						...
						if (Activity.RESULT_OK == getResultCode()) {
							...
							if (success) {
								mContentView.setTextViewText(
										MY_NOTIFICATION_ID, successMsg);
							} else {
								mContentView.setTextViewText(
										MY_NOTIFICATION_ID, failMsg);
							}
							...
							Notification notificationBuilder = new Notification.Builder(
									...
									.setContentTitle("Da Notification")
							...
							NotificationManager nManager = (NotificationManager) mParentActivity
									.getSystemService(Context.NOTIFICATION_SERVICE);
							nManager.notify(MY_NOTIFICATION_ID,
									notificationBuilder);
